...
import type { AbortableOperationOptions, AbortableQueryOptions } from '../util/abort.js';
/**
...
export interface QueryExecutor extends ConnectionProvider {
     ...
     */
    chunkSize: number, options?: AbortableOperationOptions): AsyncIterableIterator<QueryResult<R>>;
    /**
